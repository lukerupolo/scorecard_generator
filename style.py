...
STYLE_PRESETS = {
    "FC_Custom": {
        "colors": {
            "title_slide_bg": hex_to_rgb("000000"), "title_slide_text": hex_to_rgb("EEEEEE"),
            "content_slide_bg": hex_to_rgb("000000"), "content_heading_text": hex_to_rgb("00F468"),
            "content_body_text": hex_to_rgb("FFFFFF"), "table_header_bg": hex_to_rgb("00F468"),
            "table_header_text": hex_to_rgb("000000"), "table_alt_row_bg": hex_to_rgb("282828"),
        },
    ...
    "Battlefield": {
        "colors": {
            ...
            "table_header_text": hex_to_rgb("000000"), "table_alt_row_bg": hex_to_rgb("323438"),
        },
    ...
    "Apex": {
        "colors": {
            ...
            "table_header_text": hex_to_rgb("FFFFFF"), "table_alt_row_bg": hex_to_rgb("3C3C3C"),
        },
