...
!ngrok config add-authtoken YOUR_NGROK_AUTHTOKEN # Replace with your actual token
...
# Using nohup to keep it running even if the Colab cell finishes
cmd = (
...
try:
    # Use the ngrok.connect method with the specified port
    public_url = ngrok.connect(8501, bind_tls=True).public_url
    print(f"\n🌐 Your Streamlit app is live at: {public_url}")
    # You can click this URL to open your Streamlit app in a new tab.
